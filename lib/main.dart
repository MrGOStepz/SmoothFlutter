...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Demo Home Page hahaha'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _getCustomer() {
    ...
    staff.lastName = "LastNameTest";
    staff.lastName = "LastNameTest";
    staff.phoneNumber = "PhoneTest";
    staff.email = "EmailTest";
    staff.staffPosition.id = 3;
    staff.clockStatus.id = 1;
    staff.password = "123456";
    staffDAO.update(staff).then((value) {
      setState(() {
